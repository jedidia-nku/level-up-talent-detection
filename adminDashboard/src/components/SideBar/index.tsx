...
interface SidebarProps {
  ...
  <div
    ...
    >
      {/* <div
    ref={sidebar}
     className="h-screen hidden md:flex flex-col md:w-44 lg:w-64 bg-gray-800"> </div> */}
    ...
    {showModal && (
      <div className="relative fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
